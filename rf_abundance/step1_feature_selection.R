...
save(inTrain,file = 'antimicrobial_toxin/rf_abundance/inTrain_abundance.Rdata')
trainx <- x[inTrain, ]
testx <- x[-inTrain, ]
...
save(rfFuncs,file = 'antimicrobial_toxin/rf_abundance/rfFuncs_abundance.Rdata')
...
save(optvar,file = 'antimicrobial_toxin/rf_abundance/optvar51_abundance.Rdata')
