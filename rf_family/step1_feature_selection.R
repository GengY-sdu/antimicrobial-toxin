...
save(inTrain,file = 'antimicrobial_toxin/rf_family/inTrain_family.Rdata')
trainx <- x[inTrain, ]
testx <- x[-inTrain, ]
...
save(rfFuncs,file = 'antimicrobial_toxin/rf_family/rfFuncs_family.Rdata')
...
save(optvar,file = 'antimicrobial_toxin/rf_family/optvar51_family.Rdata')
